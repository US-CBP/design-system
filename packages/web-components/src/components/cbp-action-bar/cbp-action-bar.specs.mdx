...
* Action bar comes with 2 variants, inline & sticky.
    *inline: is rendered inplace. Primarily for supporting Forms, strucutred list footer, grids, etc 
    *sticky: is rendered at bottom of viewport, used for containing tools that affect the content of the whole page the user is viewing
...
* it is not advised to use both inline and sticky action bar on the same page to avoid user confusion