    ...
    <footer class="cbp-external-footer">
      ...
      <div class="cbp-footer__info">
        ...
        <ul class="cbp-external-footer__links">
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/site-policy-notices/accessibility"><i class="fas fa-arrow-right"></i>Accessibility</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/newsroom/accountability-and-transparency"><i class="fas fa-arrow-right"></i>Accountability</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.dhs.gov/operational-and-support-components"><i class="fas fa-arrow-right"></i>DHS Components</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/site-policy-notices/foia"><i class="fas fa-arrow-right"></i>FOIA</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/newsroom/publications/forms"><i class="fas fa-arrow-right"></i>Forms</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.oig.dhs.gov/taxonomy/term/1"><i class="fas fa-arrow-right"></i>Inspector General</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/about/eeo-diversity/no-fear-act"><i class="fas fa-arrow-right"></i>No FEAR Act</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/site-policy-notices/privacy-policy"><i class="fas fa-arrow-right"></i>Privacy</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.cbp.gov/site-policy-notices"><i class="fas fa-arrow-right"></i>Site Policies</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.whitehouse.gov/"><i class="fas fa-arrow-right"></i>The White House</a></li>
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.usa.gov/"><i class="fas fa-arrow-right"></i>USA.gov</a></li>
        </ul>
