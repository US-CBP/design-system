export default {
    ...
    argTypes: {
      ...
      download: {
        description: 'Indicates whether the `download` attribute is placed on the rendered anchor tag as a browser hint indicating that the linked contents specified in the `href` should be downloaded rather than navigated to.',
        control: 'boolean'
      },

      language: {
        description: 'Specifies the `lang` attribute on the rendered anchor tag, which is required when the link points to content in a language different than the current document.',
        type: 'string'
      },
      shortcutKey: {
      ...
      accessibilityText: {
        description: 'Accessibility text is applied as an `aria-label` and should be supplied when the link does not contain text or it is not sufficiently and uniquely descriptive.',
        type: 'string'
      },
      disabled: {
