...
* This component does not currently support AND or OR operators to combine media queries.
  * However, when testing for viewport width, the following format may be used to check against multiple sizes: `30rem <= width <= 60rem`.
  * If there are use cases that require the use of AND/OR operators, please discuss with the design system developers for future consideration.
