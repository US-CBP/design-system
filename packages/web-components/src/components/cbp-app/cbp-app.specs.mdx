...
<Meta title="Layout and Structure/App/Specifications" />

# cbp-app

## Purpose

The App component is a wrapper that packages high level design tokens (as CSS variables) and styles as well as acting as top level control for things like dark mode within the design system/component library.
