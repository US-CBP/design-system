...
* Tooltips are activated by focusing or clicking the triggering element.
...
* Historically, tooltips were accessible via hover but this does not conform to accessibility standards, and is completely invisible on touch-based 
