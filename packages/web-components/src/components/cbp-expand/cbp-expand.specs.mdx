...
<Meta title="Content/Expand/Specifications" />

# cbp-expand

## Purpose

A standalone component used for progressive disclosure, the Expand component organizes content under a relevant heading, which is used as a control for revealing and hiding its content.
