...
<Meta title="Content/Tag/Specifications" />
...
* Tags will not wrap and should be kept short so that truncation does not occur even on small screens.
...
* The Tag component uses an "inline-flex" display to automatically provide a gap between any icons and tag text.
