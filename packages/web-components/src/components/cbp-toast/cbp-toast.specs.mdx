...
* Multiple toast should be placed in a cbp-toast-container to manage placement
    * Props:
        * position: used to align toast-container in viewport, options include (top-left, top-center, top-left, bottom-left, bottom-center, bottom-left) defaulting to top-right
            * position prop is also used to educate the toast animations so that toasts open/dismiss will correctly animate on/off screen
