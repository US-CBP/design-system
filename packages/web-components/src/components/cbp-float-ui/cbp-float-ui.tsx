...
export const floatUI: FunctionalComponent<floatUIProps> = ({offset, flip, shift, arrow}) => (
  <div>
    {console.log('Functional component: ', offset, flip, shift, arrow)}
