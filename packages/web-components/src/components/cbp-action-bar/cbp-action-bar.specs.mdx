...
<Meta title="Content/Action bar/Specifications" />
...
* The Action Bar has three variants - inline, floating, and sticky.
  ...
  * The sticky variant is primarily intended for use within scrolling containers, such as scrolling drawer contents, where fixed positioning in the viewport is not feasible.

## Technical Specifications

### User Interactions

* As a wrapper, all user interactions are handled by the slotted components and application logic.

### Responsiveness

* The Action Bar will fill 100% of the screen (floating) or parent (inline/sticky).
