...
const StatesDropdownTemplate = ({ label, description, fieldId, name, placeholder, filter, multiple, error, readonly, disabled, value, context, sx, items }) => {
  return ` 
    <cbp-form-field
      ${label ? `label="${label}"` : ''}
...
const CountriesDropdownTemplate = ({ label, description, fieldId, name, placeholder, filter, multiple, error, readonly, disabled, value, context, sx, items }) => {
  return ` 
    <cbp-form-field
      ${label ? `label="${label}"` : ''}
      ${description ? `description="${description}"` : ''}
...
const ComboboxTemplate = ({ label, description, fieldId, name, placeholder, filter, multiple, error, readonly, disabled, value, context, sx, items }) => {
  return ` 
    <cbp-form-field
      ${label ? `label="${label}"` : ''}
      ${description ? `description="${description}"` : ''}
...
const DropdownJSONTemplate = ({ label, description, fieldId, name, placeholder, items, filter, async, minimumInputLength, multiple, error, readonly, disabled, value, context, sx }) => {
...
const ComboboxAsyncTemplate = ({ label, description, fieldId, name, placeholder, filter, async, minimumInputLength, multiple, error, readonly, disabled, value, selectedLabel, context, sx }) => {
