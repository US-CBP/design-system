...
const SimpleModalTemplate = () => {
  return `
    ...
    <dialog class="cbp-modal" id="simple-modal" aria-describedby="simple-modal-description">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__secondary" data-modal-close><i class="fas fa-trash-alt"></i>cancel</button>
        <button class="cbp-btn cbp-btn__primary"><i class="fas fa-plus"></i>add user</button>
      </div>
    </dialog>
  `
}
...
const AcknowledgementModalTemplate = () => {
  return `
    ...
    <dialog class="cbp-modal" id="acknowledge" aria-labelledby="acknowledge-modal-title" aria-describedby="acknowledge-modal-description">
      <div class="cbp-modal__content">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__primary" data-modal-close><i class="fas fa-check"></i>accept</button>
      </div>
    </dialog>
  `
}
...
const ConfirmationModalTemplate = () => {
  return `
    <button class="cbp-btn cbp-btn__primary" data-modal="confirmation">Confirmation Modal</button>
    <dialog class="cbp-modal" id="confirmation" aria-labelledby="confirmation-modal-title" aria-describedby="confirmation-modal-description">
      <div class="cbp-modal__content">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__secondary" data-modal-close><i class="fas fa-times"></i>cancel</button>
        <button class="cbp-btn cbp-btn__primary"><i class="fas fa-paper-plane"></i>submit</button>
      </div>
    </dialog>
  `
}
...
const DangerModalTemplate = () => {
  return `
    ...
    <dialog class="cbp-modal" id="danger" aria-labelledby="danger-modal-title" aria-describedby="danger-modal-description">
      <div class="cbp-modal__content">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__secondary" data-modal-close><i class="fas fa-times"></i>cancel</button>
        <button class="cbp-btn cbp-btn__danger"><i class="fas fa-trash-alt"></i>delete</button>
      </div>
    </dialog>
  `
}
...
const MultiChoiceModalTemplate = () => {
  return `
    ...
    <dialog class="cbp-modal" id="multi" aria-labelledby="multi-modal-title" aria-describedby="multi-modal-description">
      <div class="cbp-modal__content">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__secondary" data-modal-close><i class="fas fa-times"></i>cancel</button>
        <button class="cbp-btn cbp-btn__primary"><i class="fas fa-save"></i>save</button>
        <button class="cbp-btn cbp-btn__primary"><i class="fas fa-paper-plane"></i>publish</button>
      </div>
    </dialog>
  `
}
...
const FormModalTemplate = () => {
  return `
    ...
    <dialog class="cbp-modal" id="form-modal" aria-labelledby="form-modal-title" aria-describedby="form-modal-description">
      <div class="cbp-modal__content">
      ...
      <div class="cbp-modal__controls">
        <button class="cbp-btn cbp-btn__secondary" data-modal-close><i class="fas fa-times"></i>cancel</button>
        <button class="cbp-btn cbp-btn__primary"><i class="fas fa-paper-plane"></i>send</button>
      </div>
    </dialog>
  `
}
