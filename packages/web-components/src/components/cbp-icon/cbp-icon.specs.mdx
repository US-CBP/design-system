...
* External icons may be loaded by slotting component-based icons or native SVGs inside of the Icon component.
* The Icon component shall allow the icon color, size, and rotation to be specified. 
...
* Specifying a single color via the `color` property applies to both light and dark modes and should be verified to work in both color schemes.
