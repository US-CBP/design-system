...
<Meta title="Navigation/Link/Specifications" />
...
* If an icon is included alongside text, a gap will be automatically applied to separate them.
...
* The Link component uses an "inline-flex" display to automatically provide a gap between any icons and link text.
