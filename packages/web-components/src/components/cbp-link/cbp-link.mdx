...
The Link component can either render a link(anchor tag) or act as a wrapper, providing consistent styling meant for in-content links.
...
* There are no special responsive design concerns pertaining to links. By default, link text should wrap as needed.
