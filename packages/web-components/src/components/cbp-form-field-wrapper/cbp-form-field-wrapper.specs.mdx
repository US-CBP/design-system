...
<Meta title="Forms/Form Field Wrapper/Specifications" />
...
* A simple/compact File Input pattern consists of:
  * An `input type="file"`.
  * An attached "Browse" button that invokes a click() event on the native input when clicked.

### Additional Notes and Considerations

* For a more advanced/feature-rich File Input pattern, try using the `cbp-file-input` rather than the native `input type="file"`.