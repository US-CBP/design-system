...
These values support a range of possibilities to meet various design requirements, because it is not a correct assumption that something with a dark appearance or background in light mode would automatically invert to a light appearance in dark mode.
