...
The CBP Design System components support both light and dark modes, as indicated by a user's operating system preferences. There is nothing required by the developer for regular light and dark mode toggling based on user preferences.
...
These values support a range of possibilities to meet various design requirements, because it is a false assumption that something with a dark appearance or background in light mode would automatically invert to a light appearance in dark mode.
